...
function VerifValidEmail(){
    let email=document.getElementById('VerifValidEmail').value;
    let regex=new RegExp('^(?:[a-zA-Z0-9]{0,}|[a-zA-Z0-9]{0,}.[a-zA-Z0-9]{0,}|[a-zA-Z0-9]{0,}.[a-zA-Z0-9]{0,}.[a-zA-Z0-9]{0,}|[a-zA-Z0-9]{0,}.[a-zA-Z0-9]{0,}.[a-zA-Z0-9]{0,}.[a-zA-Z0-9]{0,})+@+[a-zA-Z0-9]{0,}.[a-zA-Z0-9]{0,11}$');
    let result=regex.test(email);
    if(result!=false){
        document.getElementById("VerifValidEmailP").innerHTML="your email is valid";
    }
    else {  
        document.getElementById("VerifValidEmailP").innerHTML="your email is not valid";
    }
}
/* =================================================================================================================
